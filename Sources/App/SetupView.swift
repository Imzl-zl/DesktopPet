...
struct SetupView: View {
    ...
    enum Tab { case pet, bubble, care, advanced }
    ...
    var body: some View {
        settingsColumn
        .frame(width: baseWidth, height: 600)
    ...
    private var bottomBar: some View {
        HStack(spacing: Theme.space3) {
            Text("Your pet lives in the menu bar.")
                .font(.caption)
    ...
    private var tabBar: some View {
        HStack(spacing: Theme.space2) {
            ...
            TabButton(icon: "gearshape.fill", label: "Advanced", selected: tab == .advanced) { tab = .advanced }
        }
...
// MARK: - General (language / launch / display / breaks / notifications / about)
