"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.WIDGET_KEY = exports.TEMP_ROOT_DIR = exports.TEMP_ARTIFACTS_DIR = exports.SUBAGENT_STEERING_NOTICE_EVENT = exports.SUBAGENT_RESULT_INTERCOM_EVENT = exports.SUBAGENT_RESULT_INTERCOM_DELIVERY_EVENT = exports.SUBAGENT_PROCESS_TERMINAL_EVENT = exports.SUBAGENT_LIFECYCLE_ARTIFACT_VERSION = exports.SUBAGENT_FOREGROUND_COMPLETE_EVENT = exports.SUBAGENT_CONTROL_INTERCOM_EVENT = exports.SUBAGENT_CONTROL_EVENT = exports.SUBAGENT_ASYNC_STARTED_EVENT = exports.SUBAGENT_ASYNC_COMPLETE_EVENT = exports.SUBAGENT_ACTIONS = exports.SLASH_TEXT_RESULT_TYPE = exports.SLASH_SUBAGENT_UPDATE_EVENT = exports.SLASH_SUBAGENT_STARTED_EVENT = exports.SLASH_SUBAGENT_RESPONSE_EVENT = exports.SLASH_SUBAGENT_REQUEST_EVENT = exports.SLASH_SUBAGENT_CANCEL_EVENT = exports.SLASH_RESULT_TYPE = exports.RESULTS_DIR = exports.POLL_INTERVAL_MS = exports.MAX_WIDGET_JOBS = exports.MAX_CONCURRENCY = exports.INTERCOM_DETACH_RESPONSE_EVENT = exports.INTERCOM_DETACH_REQUEST_EVENT = exports.DIRS = exports.DEFAULT_SUBAGENT_MAX_DEPTH = exports.DEFAULT_MAX_OUTPUT = exports.DEFAULT_FORK_PREAMBLE = exports.DEFAULT_ARTIFACT_CONFIG = exports.CHAIN_RUNS_DIR = exports.ASYNC_DIR = void 0;exports.checkSubagentDepth = checkSubagentDepth;exports.getAsyncConfigPath = getAsyncConfigPath;exports.getSubagentDepthEnv = getSubagentDepthEnv;exports.normalizeMaxSubagentDepth = normalizeMaxSubagentDepth;exports.normalizeMaxSubagentSpawnsPerSession = normalizeMaxSubagentSpawnsPerSession;exports.resolveChildMaxSubagentDepth = resolveChildMaxSubagentDepth;exports.resolveCurrentMaxSubagentDepth = resolveCurrentMaxSubagentDepth;exports.resolveMaxSubagentSpawnsPerSession = resolveMaxSubagentSpawnsPerSession;exports.resolveTempScopeId = resolveTempScopeId;exports.resolveTopLevelParallelConcurrency = resolveTopLevelParallelConcurrency;exports.resolveTopLevelParallelMaxTasks = resolveTopLevelParallelMaxTasks;exports.truncateOutput = truncateOutput;exports.wrapForkTask = wrapForkTask;
...
const SUBAGENT_LIFECYCLE_ARTIFACT_VERSION = exports.SUBAGENT_LIFECYCLE_ARTIFACT_VERSION = 3;
...
const SUBAGENT_PROCESS_TERMINAL_EVENT = exports.SUBAGENT_PROCESS_TERMINAL_EVENT = "subagent:process-terminal";
const SUBAGENT_FOREGROUND_COMPLETE_EVENT = exports.SUBAGENT_FOREGROUND_COMPLETE_EVENT = "subagent:foreground-complete";
...
const SUBAGENT_STEERING_NOTICE_EVENT = exports.SUBAGENT_STEERING_NOTICE_EVENT = "subagent:steering-notice";
...
const SLASH_TEXT_RESULT_TYPE = exports.SLASH_TEXT_RESULT_TYPE = "subagent-slash-text-result";
...
const SUBAGENT_ACTIONS = exports.SUBAGENT_ACTIONS = ["list", "get", "models", "create", "update", "delete", "eject", "disable", "enable", "reset", "mission.create", "mission.list", "mission.show", "mission.update", "mission.attach-run", "mission.close", "worktree.discard", "inspector.open", "inspector.status", "inspector.close", "project.open", "project.status", "project.close", "status", "grant-spawn-budget", "interrupt", "resume", "steer", "stop", "append-step", "approve-checkpoint", "reject-checkpoint", "doctor", "watchdog.status", "watchdog.check", "watchdog.configure", "watchdog.recommend-model", "schedule.create", "schedule.list", "schedule.show", "schedule.history", "schedule.pause", "schedule.resume", "schedule.run", "schedule.run-due", "schedule.delete"];
...
function normalizeMaxSubagentSpawnsPerSession(value) {
  return normalizeNonNegativeInteger(value);
}

function resolveMaxSubagentSpawnsPerSession(configMaxSpawns) {
