...
const TOOL_BUDGET_ZERO_AUTH_ENV = exports.TOOL_BUDGET_ZERO_AUTH_ENV = "PI_SUBAGENT_TOOL_BUDGET_ZERO_AUTH";
...
function validateToolBudgetConfig(
raw,
label = "toolBudget",
options = {})
{
...
function decodeToolBudgetEnv(value, options = {}) {
