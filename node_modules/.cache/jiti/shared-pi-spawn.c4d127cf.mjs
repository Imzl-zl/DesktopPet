"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.PI_SUBAGENT_PI_BINARY_ENV = exports.PI_CODING_AGENT_PACKAGE = void 0;exports.findPiPackageRootFromEntry = findPiPackageRootFromEntry;exports.getPiSpawnCommand = getPiSpawnCommand;exports.resolveInstalledPiPackageRoot = resolveInstalledPiPackageRoot;exports.resolvePiCliScript = resolvePiCliScript;exports.resolvePiPackageRoot = resolvePiPackageRoot;var fs = _interopRequireWildcard(await jitiImport("node:fs"));
...
const PI_CODING_AGENT_PACKAGE = exports.PI_CODING_AGENT_PACKAGE = "@earendil-works/pi-coding-agent";
const PI_SUBAGENT_PI_BINARY_ENV = exports.PI_SUBAGENT_PI_BINARY_ENV = "PI_SUBAGENT_PI_BINARY";

function findPiPackageRootFromEntry(
entryPoint)
{
...
function resolveInstalledPiPackageRoot() {
  return findPiPackageRootFromEntry(
    (0, _nodeUrl.fileURLToPath)(jitiESMResolve(PI_CODING_AGENT_PACKAGE))
  );
}
