"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.resolveAsyncRootResultPath = resolveAsyncRootResultPath;exports.waitForImportedAsyncRoot = waitForImportedAsyncRoot;var fs = _interopRequireWildcard(await jitiImport("node:fs"));
...
async function waitForImportedAsyncRoot(
root,
options = {})
{
  ...
  let terminalSince;
  for (;;) {
    const status = (0, _utils.readStatus)(root.asyncDir);
...
function resolveAsyncRootResultPath(resultsDir, runId) {
