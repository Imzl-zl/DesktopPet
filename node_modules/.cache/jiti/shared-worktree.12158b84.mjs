...
var _authority = await jitiImport("../../policy/authority.ts");function _interopRequireWildcard(e, t) {if ("function" == typeof WeakMap) var r = new WeakMap(),n = new WeakMap();return (_interopRequireWildcard = function (e, t) {if (!t && e && e.__esModule) return e;var o,i,f = { __proto__: null, default: e };if (null === e || "object" != typeof e && "function" != typeof e) return f;if (o = t ? n : r) {if (o.has(e)) return o.get(e);o.set(e, f);}for (const t in e) "default" !== t && {}.hasOwnProperty.call(e, t) && ((i = (o = Object.defineProperty) && Object.getOwnPropertyDescriptor(e, t)) && (i.get || i.set) ? o(f, t, i) : f[t] = e[t]);return f;})(e, t);}
...
function resolveExpectedWorktreeAgentCwd(cwd, runId, index, baseDir) {
  const cwdRelative = resolveRepoCwdRelative(cwd);
...
function emptyDiff(index, agent, branch, patchPath, error) {
  return {
    index,
    agent,
    branch,
...
function handoffRecordsPatch(manifestPath, patchPath) {
...
intent)
{
  ...
  if (intent.kind !== "setup-rollback") {
    ...
    if (hasWork && intent.kind === "discard") {
      const decision = (0, _authority.resolveAuthorityDecision)({ action: "discardWorktree", policy: intent.authorization.policy });
...
setup,
intent = { kind: "preserve", ...(setup.capturedDiffs ? { capturedDiffs: setup.capturedDiffs } : {}) })
{
  const tasks = [];
