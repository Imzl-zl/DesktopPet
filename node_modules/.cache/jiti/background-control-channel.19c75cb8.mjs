"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.INTERRUPT_SIGNAL = void 0;exports.approveCheckpointRequestPath = approveCheckpointRequestPath;exports.closeSteerInbox = closeSteerInbox;exports.consumeCheckpointDecisionRequest = consumeCheckpointDecisionRequest;exports.consumeInterruptRequest = consumeInterruptRequest;exports.consumeSteerAcks = consumeSteerAcks;exports.consumeSteerCapabilities = consumeSteerCapabilities;exports.consumeSteerRequests = consumeSteerRequests;exports.consumeSteerRequestsFromDir = consumeSteerRequestsFromDir;exports.consumeStopRequest = consumeStopRequest;exports.consumeTimeoutRequest = consumeTimeoutRequest;exports.controlInboxDir = controlInboxDir;exports.deliverCheckpointDecisionRequest = deliverCheckpointDecisionRequest;exports.deliverInterruptRequest = deliverInterruptRequest;exports.deliverStopRequest = deliverStopRequest;exports.deliverTimeoutRequest = deliverTimeoutRequest;exports.enqueueStepSteer = enqueueStepSteer;exports.interruptRequestPath = interruptRequestPath;exports.readSteerCapability = readSteerCapability;exports.rejectCheckpointRequestPath = rejectCheckpointRequestPath;exports.requestAsyncCheckpointDecision = requestAsyncCheckpointDecision;exports.requestAsyncInterrupt = requestAsyncInterrupt;exports.requestAsyncSteer = requestAsyncSteer;exports.requestAsyncStop = requestAsyncStop;exports.requestAsyncTimeout = requestAsyncTimeout;exports.steerAckPathFromDir = steerAckPathFromDir;exports.steerAcksDir = steerAcksDir;exports.steerCapabilitiesDir = steerCapabilitiesDir;exports.steerCapabilityPath = steerCapabilityPath;exports.steerInboxClosedPath = steerInboxClosedPath;exports.steerRequestsDir = steerRequestsDir;exports.stepSteerInboxDir = stepSteerInboxDir;exports.stopRequestPath = stopRequestPath;exports.timeoutRequestPath = timeoutRequestPath;exports.watchAsyncControlInbox = watchAsyncControlInbox;exports.writeSteerAck = writeSteerAck;exports.writeSteerAckAt = writeSteerAckAt;exports.writeSteerCapability = writeSteerCapability;exports.writeSteerCapabilityAt = writeSteerCapabilityAt;exports.writeSteerRequestToDir = writeSteerRequestToDir;
...
function approveCheckpointRequestPath(asyncDir) {
  return path.join(controlInboxDir(asyncDir), "approve-checkpoint.json");
}

function rejectCheckpointRequestPath(asyncDir) {
...
function closeSteerInbox(asyncDir, state) {
  (0, _atomicJson.writeAtomicJson)(steerInboxClosedPath(asyncDir), { version: 1, closedAt: Date.now(), state });
}
...
function writeSteerCapabilityAt(filePath, capability) {
  ...
  const record = { type: "steer-capability", protocolVersion: 1, ...capability };
  (0, _atomicJson.writeAtomicJson)(filePath, record);
  return filePath;
}

function writeSteerCapability(asyncDir, capability) {
  return writeSteerCapabilityAt(steerCapabilityPath(asyncDir, capability.index), capability);
}

function writeSteerAckAt(filePath, ack) {
  ...
  const record = { type: "steer-ack", protocolVersion: 1, ...ack, message: ack.message.trim() };
  (0, _atomicJson.writeAtomicJson)(filePath, record);
  return filePath;
}

function writeSteerAck(asyncDir, ack) {
...
function requestAsyncCheckpointDecision(
asyncDir,
type,
payload = {},
deps = {})
{
  ...
  const request = { ...payload, ts: payload.ts ?? deps.now?.() ?? Date.now(), type };
  (0, _atomicJson.writeAtomicJson)(requestPath, request);
  return requestPath;
}
...
function consumeSteerCapabilities(asyncDir, fsImpl = fs) {
...
function consumeSteerAcks(asyncDir, fsImpl = fs) {
...
function consumeCheckpointDecisionRequest(
asyncDir,
fsImpl = fs)
{
...
function deliverStopRequest(input)
...
function deliverCheckpointDecisionRequest(input)
...

{
  ...
  let watcher;
  try {
    watcher = fsImpl.watch((0, _utils.resolveWatchPath)(dir, fsImpl.realpathSync.native), () => check());
    watcher.on?.("error", () => {
