"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.ChainOutputValidationError = void 0;exports.outputEntryFromAsyncResult = outputEntryFromAsyncResult;exports.outputEntryFromResult = outputEntryFromResult;exports.resolveOutputReferences = resolveOutputReferences;exports.validateChainOutputBindings = validateChainOutputBindings;exports.validateChainOutputBindingsWithContext = validateChainOutputBindingsWithContext;var _settings = await jitiImport("../../shared/settings.ts");
...
function outputNamesForStep(step) {
  if ((0, _settings.isCheckpointStep)(step)) return [];
...
context = {})
{
  ...
  for (let stepIndex = 0; stepIndex < steps.length; stepIndex++) {
    ...
    if ((0, _dynamicFanout.hasDynamicFanoutFields)(step)) {
      ...
      try {
        (0, _dynamicFanout.validateDynamicStepShape)(step, displayStepIndex - 1, dynamicFanoutConfig);
      } catch (error) {
