...
/// user types per mood. Drives the pet's speech bubble.
@MainActor
final class ChatSettings: ObservableObject {
    ...
    private static let sourceKey = "desktoppet.chatSource"
    private static let customKey = "desktoppet.chatCustom"
