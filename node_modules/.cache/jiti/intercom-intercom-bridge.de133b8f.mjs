...
const NATIVE_INTERCOM_EXTENSION_DIR = exports.NATIVE_INTERCOM_EXTENSION_DIR = "native:pi-subagents-supervisor-channel";

function defaultAgentDir() {
  return (0, _utils.getAgentDir)();
}
...
function resolveIntercomSessionTarget(sessionName, sessionId, intercomSessionId = process.env[PI_INTERCOM_SESSION_ID_ENV]) {
