...
var _processSignal = await jitiImport("./process-signal.ts");
...
const SIGKILL_PROCESS_SIGNAL_ERROR = (0, _processSignal.formatProcessSignalError)("SIGKILL");
