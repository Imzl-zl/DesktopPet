 ...
 */function createParallelDirs(chainDir, stepIndex, taskCount, agentNames) {for (let i = 0; i < taskCount; i++) {const subdir = path.join(chainDir, `parallel-${stepIndex}`, `${i}-${agentNames[i]}`);fs.mkdirSync(subdir, { recursive: true });}} /* v9-38cd28f92ffc1067 */
