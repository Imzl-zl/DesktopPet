"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.INHERIT_MODEL = void 0;exports.buildModelCandidates = buildModelCandidates;exports.formatModelAttemptNote = formatModelAttemptNote;exports.fuzzyResolveModel = fuzzyResolveModel;exports.isRetryableModelFailure = isRetryableModelFailure;exports.normalizeModelSegment = normalizeModelSegment;exports.normalizeParentModel = normalizeParentModel;exports.resolveEffectiveSubagentModel = resolveEffectiveSubagentModel;exports.resolveModelCandidate = resolveModelCandidate;exports.resolveSubagentModelOverride = resolveSubagentModelOverride;exports.splitThinkingSuffix = splitThinkingSuffix;

var _modelScope = await jitiImport("./model-scope.ts");
...
const INHERIT_MODEL = exports.INHERIT_MODEL = "inherit";
...
options)
{
  ...
  if (resolved && options?.scope?.enforce) {
    ...
    const violation = (0, _modelScope.checkModelScope)(resolved, options.scope, source);
    if (violation) {
...
function resolveEffectiveSubagentModel(
explicitModel,
agentModel,
parentModel,
availableModels,
...
options)
{
  ...
  for (let index = 0; index < rawCandidates.length; index++) {
    ...
    if (index > 0 && options?.scope?.enforce) {
      const violation = (0, _modelScope.checkModelScope)(normalized, options.scope, "inherited");
