...
var _processTerminal = await jitiImport("../background/process-terminal.ts");function _interopRequireWildcard(e, t) {if ("function" == typeof WeakMap) var r = new WeakMap(),n = new WeakMap();return (_interopRequireWildcard = function (e, t) {if (!t && e && e.__esModule) return e;var o,i,f = { __proto__: null, default: e };if (null === e || "object" != typeof e && "function" != typeof e) return f;if (o = t ? n : r) {if (o.has(e)) return o.get(e);o.set(e, f);}for (const t in e) "default" !== t && {}.hasOwnProperty.call(e, t) && ((i = (o = Object.defineProperty) && Object.getOwnPropertyDescriptor(e, t)) && (i.get || i.set) ? o(f, t, i) : f[t] = e[t]);return f;})(e, t);}
...
function isTopLevelAsyncDir(asyncDir) {
  ...
  return containedPath(_types.ASYNC_DIR, resolved) && !containedPath(path.join(_types.TEMP_ROOT_DIR, "nested-subagent-runs"), resolved);
}

function nestedResultsPath(rootRunId, id) {
  assertSafeId("rootRunId", rootRunId);
  assertSafeId("id", id);
  return path.join(_types.RESULTS_DIR, "nested", rootRunId, `${id}.json`);
} /* v9-3e820c6a72883220 */
